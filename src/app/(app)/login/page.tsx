              ...
              <div className="grid gap-4">
                ...
                <div className="flex justify-between">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="remember"
                      className="border-slate-300 data-[state=checked]:border-purple-600 data-[state=checked]:bg-purple-600 dark:border-slate-600 dark:data-[state=checked]:border-purple-500 dark:data-[state=checked]:bg-purple-500"
                    />
                    <label
                      htmlFor="remember"
                  ...
                  <a
                    href="#"
                    className="text-sm font-medium text-purple-600 transition-colors duration-200 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300"
                  >
                    Forgot password
                  </a>
                </div>
